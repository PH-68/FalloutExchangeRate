import { Chart, Colors, BarController, BarElement, LineController, LineElement, PointElement, LinearScale, TimeScale, Tooltip, Legend } from 'chart.js'
import zoomPlugin from 'chartjs-plugin-zoom';
import 'chartjs-adapter-date-fns';
import { getTransactionArray } from './transaction-log';

Chart.register(zoomPlugin, Colors, Tooltip, Legend, BarController, BarElement, LineController, LineElement, PointElement, LinearScale, TimeScale);
